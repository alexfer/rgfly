...
class Entry
{
    ...
    #[ORM\OneToOne(targetEntity: EntryDetails::class, mappedBy: 'entry', orphanRemoval: true, cascade: ['persist'])]
    private ?EntryDetails $details = null;
    ...
    public function setDetails(?EntryDetails $details): self
    {
