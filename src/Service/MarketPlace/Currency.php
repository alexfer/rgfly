...
class Currency
{
    ...
    private const string COUNTRY_NAME = 'country_name';
    private const string CURRENCY = 'currency';
    private const string SYMBOL = 'symbol';
    private const string SYMBOL_NATIVE = 'symbol_native';
    private const string DECIMAL_DIGITS = 'decimal_digits';
    private const string ROUNDING = 'rounding';
    private const string NAME_PLURAL = 'name_plural';
