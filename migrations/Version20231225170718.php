 ...
 */
final class Version20231225170718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_93EA846BA23B42D ON market_product_manufacturer (manufacturer_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C403355EA53A8AA ON market_product_provider (provider_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CDED2ABC2ADD6D8C ON market_product_supplier (supplier_id)');
