...
final class Version20231224120521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE market_provider ADD CONSTRAINT FK_7F756654622F3F37 FOREIGN KEY (market_id) REFERENCES brand (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
