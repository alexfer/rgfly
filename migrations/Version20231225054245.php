...
final class Version20231225054245 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE market_supplier ADD CONSTRAINT FK_769B79B6622F3F37 FOREIGN KEY (market_id) REFERENCES brand (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
